...
function investment_ready_actions() {
	...
	if ( (INVESTMENT_STORAGE['toc_menu'] != 'no') && (INVESTMENT_STORAGE['toc_menu'] != 'hide') ) {
	...
	jQuery('.woocommerce,.woocommerce-page').on('click', '.mode_buttons a', function(e) {
		...
		investment_set_cookie('investment_shop_mode', mode, 365);
	...
	jQuery('.bookmarks_add').on('click', function(e) {
		...
		var list = investment_get_cookie('investment_bookmarks');
		var exists = false;
		if (list) {
			try {
		...
		if (!exists) {
			var message_popup = investment_message_dialog('<label for="bookmark_title">'+INVESTMENT_STORAGE['strings']['bookmark_title']+'</label><br><input type="text" id="bookmark_title" name="bookmark_title" value="'+title+'">', INVESTMENT_STORAGE['strings']['bookmark_add'], null,
				function(btn, popup) {
                    ...
                    investment_set_cookie('investment_bookmarks', JSON.stringify(list), 365);
